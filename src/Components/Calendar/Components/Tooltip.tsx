    ...
    return (
        <StyledTooltipContent className={classes.content} color={resource.color}>
            <Grid container alignItems='flex-start' className={classes.titleContainer}>
                ...
                <Grid item xs={10}>
                    <div>
                        ...
                        <div className={classNames(classes.text, classes.dateAndTitle)}>{formatDate(appointmentData.startDate, { day: 'numeric', weekday: 'long' })}</div>
                    </div>
                </Grid>
            </Grid>
            ...
            <Grid container alignItems='center' className={classes.contentContainer}>
                ...
                <Grid item xs={10}>
                    <div className={classes.text}>
                        {appointmentData.place} {appointmentData.street && `- ${appointmentData.street}`} {appointmentData.house_number && `n.º ${appointmentData.house_number}`}{' '}
                        {appointmentData.district && `, ${appointmentData.district}`} {appointmentData.city && `, ${appointmentData.city}`} {appointmentData.state && `- ${appointmentData.state}`}
                    </div>
                </Grid>
            </Grid>
            <Grid container alignItems='center' className={classes.contentContainer}>
